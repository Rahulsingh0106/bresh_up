...
import { PanelLeftIcon, Bot } from "lucide-react"
    ...
    return (
        <nav className="shadow-md px-3 py-5 flex justify-between h-[4rem] bg-(--color-slate-900)">
            ...
            <div className="flex flex-start">
                    ...
                    <HoverCard>
                        ...
                        <HoverCardContent>
                            <div className="absolute left-0 top-full z-90 mt-2 w-48 min-w-[320px] rounded-lg bg-slate-800 py-2 shadow-xl transition-all duration-100 pointer-events-auto visible translate-y-2.5 opacity-100" role="menu">
                                <a href="/courses/sql" className="group flex items-center gap-3 px-4 py-2.5 text-gray-400 transition-colors hover:bg-slate-700" role="menuitem">
                                    ...
                                    <span className="flex h-[40px] w-[40px] items-center justify-center rounded-full bg-slate-600 transition-colors group-hover:bg-slate-500 group-hover:text-slate-100">
                                        {/* <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-database inline-block h-5 w-5">
                                ...
                                <a href="/courses/sql" className="group flex items-center gap-3 px-4 py-2.5 text-gray-400 transition-colors hover:bg-slate-700" role="menuitem">
                                    ...
                                    <span className="flex flex-col">
                                        ...
                                        <span className="text-sm">
                                            Test and Practice your Knowledge
                                        </span>
                                    </span>
                                </a>
                            </div>
                ...
                <div className="flex-col-1">
                    <Link href="/" className="text-xl font-bold text-(--color-slate-400) hover:text-white">
                        MyApp
                    </Link>
                </div>
            </div>
